...
CREATE SEQUENCE jhi_user_id_seq START 1;

ALTER TABLE jhi_user ALTER COLUMN id
SET
    DEFAULT nextval ('jhi_user_id_seq');
...
SELECT gen_random_uuid (), 'System Administrator', '+55 11 99999-9999', u.id, NULL
FROM jhi_user u
WHERE
    u.login = 'admin';
...
SELECT gen_random_uuid (), 'Administrador', '+55 24 99246-9052', u.id, NULL
FROM jhi_user u
WHERE
    u.login = 'aquadros';
...
SELECT gen_random_uuid (), 'Administrador', '+55 21 98749-1500', u.id, NULL
FROM jhi_user u
WHERE
    u.login = 'ducharme';
...
SELECT gen_random_uuid (), 'Administrador', '+55 63 99913-0469', u.id, NULL
FROM jhi_user u
WHERE
    u.login = 'cleiner';
