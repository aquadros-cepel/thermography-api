...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './plant.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLANT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PLANT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PLANT actions', async () => {
      const arg = { id: '60abf610-0cb8-45cb-afc6-549737b96734' };
    ...
    it('dispatches UPDATE_PLANT actions', async () => {
      const arg = { id: '60abf610-0cb8-45cb-afc6-549737b96734' };
    ...
    it('dispatches PARTIAL_UPDATE_PLANT actions', async () => {
    ...
    it('dispatches DELETE_PLANT actions', async () => {
      const arg = 42666;
