...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSPECTIONROUTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSPECTIONROUTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSPECTIONROUTE actions', async () => {
      const arg = { id: 'e2f5eb48-b5fb-4a76-bc0d-ddddad0f3cf4' };
    ...
    it('dispatches UPDATE_INSPECTIONROUTE actions', async () => {
      const arg = { id: 'e2f5eb48-b5fb-4a76-bc0d-ddddad0f3cf4' };
    ...
    it('dispatches PARTIAL_UPDATE_INSPECTIONROUTE actions', async () => {
    ...
    it('dispatches DELETE_INSPECTIONROUTE actions', async () => {
      const arg = 42666;
