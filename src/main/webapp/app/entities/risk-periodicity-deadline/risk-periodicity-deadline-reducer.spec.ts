...
import reducer, {
  ...
  reset,
  updateEntity,
} from './risk-periodicity-deadline.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RISKPERIODICITYDEADLINE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RISKPERIODICITYDEADLINE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RISKPERIODICITYDEADLINE actions', async () => {
      const arg = { id: '55e532a0-0dd1-4afd-bcd3-8a3376f5d0d6' };
    ...
    it('dispatches UPDATE_RISKPERIODICITYDEADLINE actions', async () => {
      const arg = { id: '55e532a0-0dd1-4afd-bcd3-8a3376f5d0d6' };
    ...
    it('dispatches PARTIAL_UPDATE_RISKPERIODICITYDEADLINE actions', async () => {
    ...
    it('dispatches DELETE_RISKPERIODICITYDEADLINE actions', async () => {
      const arg = 42666;
