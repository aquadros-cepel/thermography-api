...
export const CompanyDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="thermographyApiApp.company.delete.question">
        <Translate contentKey="thermographyApiApp.company.delete.question" interpolate={{ id: companyEntity.id }}>
