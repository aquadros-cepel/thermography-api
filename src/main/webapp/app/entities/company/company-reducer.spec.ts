...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './company.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches CREATE_COMPANY actions', async () => {
      const arg = { id: '923bfdd4-0968-49ec-af05-6987429bf810' };
