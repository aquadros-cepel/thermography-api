  ...
  return (
    <div>
      <h2 id="company-heading" data-cy="CompanyHeading">
        <Translate contentKey="thermographyApiApp.company.home.title">Companies</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="thermographyApiApp.company.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/company/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="thermographyApiApp.company.home.createLabel">Create new Company</Translate>
          </Link>
        </div>
      </h2>
        ...
        {companyList && companyList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('primaryPhoneNumber')}>
                  <Translate contentKey="thermographyApiApp.company.primaryPhoneNumber">Primary Phone Number</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('primaryPhoneNumber')} />
                </th>
                <th className="hand" onClick={sort('secondaryPhoneNumber')}>
                  <Translate contentKey="thermographyApiApp.company.secondaryPhoneNumber">Secondary Phone Number</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('secondaryPhoneNumber')} />
                </th>
                <th className="hand" onClick={sort('taxIdNumber')}>
                  <Translate contentKey="thermographyApiApp.company.taxIdNumber">Tax Id Number</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('taxIdNumber')} />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="thermographyApiApp.company.home.notFound">No Companies found</Translate>
            </div>
          )
        )}
      </div>
