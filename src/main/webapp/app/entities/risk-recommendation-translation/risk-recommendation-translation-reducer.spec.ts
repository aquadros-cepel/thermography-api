...
import reducer, {
  ...
  reset,
  updateEntity,
} from './risk-recommendation-translation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RISKRECOMMENDATIONTRANSLATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RISKRECOMMENDATIONTRANSLATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RISKRECOMMENDATIONTRANSLATION actions', async () => {
      const arg = { id: 'dd845672-44a8-4766-ad4c-4ab561f7ab37' };
    ...
    it('dispatches UPDATE_RISKRECOMMENDATIONTRANSLATION actions', async () => {
      const arg = { id: 'dd845672-44a8-4766-ad4c-4ab561f7ab37' };
    ...
    it('dispatches PARTIAL_UPDATE_RISKRECOMMENDATIONTRANSLATION actions', async () => {
    ...
    it('dispatches DELETE_RISKRECOMMENDATIONTRANSLATION actions', async () => {
      const arg = 42666;
