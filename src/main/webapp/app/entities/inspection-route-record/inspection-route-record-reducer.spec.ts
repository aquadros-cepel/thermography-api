...
import reducer, {
  ...
  reset,
  updateEntity,
} from './inspection-route-record.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSPECTIONROUTERECORD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSPECTIONROUTERECORD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSPECTIONROUTERECORD actions', async () => {
      const arg = { id: 'bdef9f2f-6d5c-414f-880c-9f448f7d1936' };
    ...
    it('dispatches UPDATE_INSPECTIONROUTERECORD actions', async () => {
      const arg = { id: 'bdef9f2f-6d5c-414f-880c-9f448f7d1936' };
    ...
    it('dispatches PARTIAL_UPDATE_INSPECTIONROUTERECORD actions', async () => {
    ...
    it('dispatches DELETE_INSPECTIONROUTERECORD actions', async () => {
      const arg = 42666;
