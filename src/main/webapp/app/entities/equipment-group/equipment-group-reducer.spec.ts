...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EQUIPMENTGROUP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EQUIPMENTGROUP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EQUIPMENTGROUP actions', async () => {
      const arg = { id: 'a20929de-09f9-4475-a5bc-fcfb4efa3169' };
    ...
    it('dispatches UPDATE_EQUIPMENTGROUP actions', async () => {
      const arg = { id: 'a20929de-09f9-4475-a5bc-fcfb4efa3169' };
    ...
    it('dispatches PARTIAL_UPDATE_EQUIPMENTGROUP actions', async () => {
    ...
    it('dispatches DELETE_EQUIPMENTGROUP actions', async () => {
      const arg = 42666;
