...
import reducer, {
  ...
  reset,
  updateEntity,
} from './inspection-record.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSPECTIONRECORD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSPECTIONRECORD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSPECTIONRECORD actions', async () => {
      const arg = { id: 'b917327f-98e2-4837-907f-4fd63f00f8df' };
    ...
    it('dispatches UPDATE_INSPECTIONRECORD actions', async () => {
      const arg = { id: 'b917327f-98e2-4837-907f-4fd63f00f8df' };
    ...
    it('dispatches PARTIAL_UPDATE_INSPECTIONRECORD actions', async () => {
    ...
    it('dispatches DELETE_INSPECTIONRECORD actions', async () => {
      const arg = 42666;
