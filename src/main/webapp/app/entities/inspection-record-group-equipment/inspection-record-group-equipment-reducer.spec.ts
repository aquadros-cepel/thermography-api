...
import reducer, {
  ...
  reset,
  updateEntity,
} from './inspection-record-group-equipment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSPECTIONRECORDGROUPEQUIPMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSPECTIONRECORDGROUPEQUIPMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSPECTIONRECORDGROUPEQUIPMENT actions', async () => {
      const arg = { id: 'e5af166e-cd5e-4730-a82e-f07ead55a5c4' };
    ...
    it('dispatches UPDATE_INSPECTIONRECORDGROUPEQUIPMENT actions', async () => {
      const arg = { id: 'e5af166e-cd5e-4730-a82e-f07ead55a5c4' };
    ...
    it('dispatches PARTIAL_UPDATE_INSPECTIONRECORDGROUPEQUIPMENT actions', async () => {
    ...
    it('dispatches DELETE_INSPECTIONRECORDGROUPEQUIPMENT actions', async () => {
      const arg = 42666;
