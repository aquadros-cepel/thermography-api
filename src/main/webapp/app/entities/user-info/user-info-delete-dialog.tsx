...
export const UserInfoDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="thermographyApiApp.userInfo.delete.question">
        <Translate contentKey="thermographyApiApp.userInfo.delete.question" interpolate={{ id: userInfoEntity.id }}>
