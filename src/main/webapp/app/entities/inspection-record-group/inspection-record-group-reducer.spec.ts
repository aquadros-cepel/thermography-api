...
import reducer, {
  ...
  reset,
  updateEntity,
} from './inspection-record-group.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSPECTIONRECORDGROUP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSPECTIONRECORDGROUP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSPECTIONRECORDGROUP actions', async () => {
      const arg = { id: 'f941d6b5-a8d9-43b2-8241-67e46247ed2a' };
    ...
    it('dispatches UPDATE_INSPECTIONRECORDGROUP actions', async () => {
      const arg = { id: 'f941d6b5-a8d9-43b2-8241-67e46247ed2a' };
    ...
    it('dispatches PARTIAL_UPDATE_INSPECTIONRECORDGROUP actions', async () => {
    ...
    it('dispatches DELETE_INSPECTIONRECORDGROUP actions', async () => {
      const arg = 42666;
