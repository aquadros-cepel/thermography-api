...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_THERMOGRAM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_THERMOGRAM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_THERMOGRAM actions', async () => {
      const arg = { id: 'a0376258-83e7-465a-aa6a-04d3a149a23e' };
    ...
    it('dispatches UPDATE_THERMOGRAM actions', async () => {
      const arg = { id: 'a0376258-83e7-465a-aa6a-04d3a149a23e' };
    ...
    it('dispatches PARTIAL_UPDATE_THERMOGRAM actions', async () => {
    ...
    it('dispatches DELETE_THERMOGRAM actions', async () => {
      const arg = 42666;
