...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './equipment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EQUIPMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EQUIPMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EQUIPMENT actions', async () => {
      const arg = { id: 'a05a4b9d-a591-4e58-ab21-174ed36748f6' };
    ...
    it('dispatches UPDATE_EQUIPMENT actions', async () => {
      const arg = { id: 'a05a4b9d-a591-4e58-ab21-174ed36748f6' };
    ...
    it('dispatches PARTIAL_UPDATE_EQUIPMENT actions', async () => {
    ...
    it('dispatches DELETE_EQUIPMENT actions', async () => {
      const arg = 42666;
