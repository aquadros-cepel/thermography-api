...
export const EquipmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="thermographyApiApp.equipment.delete.question">
        <Translate contentKey="thermographyApiApp.equipment.delete.question" interpolate={{ id: equipmentEntity.id }}>
