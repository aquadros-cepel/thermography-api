...
import reducer, {
  ...
  reset,
  updateEntity,
} from './inspection-route-group-equipment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSPECTIONROUTEGROUPEQUIPMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSPECTIONROUTEGROUPEQUIPMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSPECTIONROUTEGROUPEQUIPMENT actions', async () => {
      const arg = { id: '0eefdc51-19aa-4911-8f50-cf14e7d6eb11' };
    ...
    it('dispatches UPDATE_INSPECTIONROUTEGROUPEQUIPMENT actions', async () => {
      const arg = { id: '0eefdc51-19aa-4911-8f50-cf14e7d6eb11' };
    ...
    it('dispatches PARTIAL_UPDATE_INSPECTIONROUTEGROUPEQUIPMENT actions', async () => {
    ...
    it('dispatches DELETE_INSPECTIONROUTEGROUPEQUIPMENT actions', async () => {
      const arg = 42666;
