...
import reducer, {
  ...
  reset,
  updateEntity,
} from './equipment-component-temperature-limits.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EQUIPMENTCOMPONENTTEMPERATURELIMITS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EQUIPMENTCOMPONENTTEMPERATURELIMITS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EQUIPMENTCOMPONENTTEMPERATURELIMITS actions', async () => {
      const arg = { id: '9cd54337-d62d-48fe-887e-59a6f5bd2f5e' };
    ...
    it('dispatches UPDATE_EQUIPMENTCOMPONENTTEMPERATURELIMITS actions', async () => {
      const arg = { id: '9cd54337-d62d-48fe-887e-59a6f5bd2f5e' };
    ...
    it('dispatches PARTIAL_UPDATE_EQUIPMENTCOMPONENTTEMPERATURELIMITS actions', async () => {
    ...
    it('dispatches DELETE_EQUIPMENTCOMPONENTTEMPERATURELIMITS actions', async () => {
      const arg = 42666;
