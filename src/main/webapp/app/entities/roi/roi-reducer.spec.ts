...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './roi.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROI_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ROI actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ROI actions', async () => {
      const arg = { id: '9e08ed1e-6874-4841-b108-402d9759b8f9' };
    ...
    it('dispatches UPDATE_ROI actions', async () => {
      const arg = { id: '9e08ed1e-6874-4841-b108-402d9759b8f9' };
    ...
    it('dispatches PARTIAL_UPDATE_ROI actions', async () => {
    ...
    it('dispatches DELETE_ROI actions', async () => {
      const arg = 42666;
