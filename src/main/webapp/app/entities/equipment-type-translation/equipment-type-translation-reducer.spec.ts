...
import reducer, {
  ...
  reset,
  updateEntity,
} from './equipment-type-translation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EQUIPMENTTYPETRANSLATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EQUIPMENTTYPETRANSLATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EQUIPMENTTYPETRANSLATION actions', async () => {
      const arg = { id: '37fb1164-ea59-4d4c-b8e7-d0c3d06ac53c' };
    ...
    it('dispatches UPDATE_EQUIPMENTTYPETRANSLATION actions', async () => {
      const arg = { id: '37fb1164-ea59-4d4c-b8e7-d0c3d06ac53c' };
    ...
    it('dispatches PARTIAL_UPDATE_EQUIPMENTTYPETRANSLATION actions', async () => {
    ...
    it('dispatches DELETE_EQUIPMENTTYPETRANSLATION actions', async () => {
      const arg = 42666;
