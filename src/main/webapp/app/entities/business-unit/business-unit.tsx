  ...
  return (
    <div>
      <h2 id="business-unit-heading" data-cy="BusinessUnitHeading">
        <Translate contentKey="thermographyApiApp.businessUnit.home.title">Business Units</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="thermographyApiApp.businessUnit.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/business-unit/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="thermographyApiApp.businessUnit.home.createLabel">Create new Business Unit</Translate>
          </Link>
        </div>
      </h2>
        ...
        {businessUnitList && businessUnitList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="thermographyApiApp.businessUnit.company">Company</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button tag={Link} to={`/business-unit/${businessUnit.id}/edit`} color="primary" size="sm" data-cy="entityEditButton">
                      ...
                      <Button
                        onClick={() => (window.location.href = `/business-unit/${businessUnit.id}/delete`)}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="thermographyApiApp.businessUnit.home.notFound">No Business Units found</Translate>
            </div>
          )
        )}
      </div>
