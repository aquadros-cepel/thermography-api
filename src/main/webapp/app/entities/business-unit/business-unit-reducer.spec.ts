...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUSINESSUNIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BUSINESSUNIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BUSINESSUNIT actions', async () => {
      const arg = { id: '33f2644e-bcb8-48a0-91e0-47771117c209' };
    ...
    it('dispatches UPDATE_BUSINESSUNIT actions', async () => {
      const arg = { id: '33f2644e-bcb8-48a0-91e0-47771117c209' };
    ...
    it('dispatches PARTIAL_UPDATE_BUSINESSUNIT actions', async () => {
    ...
    it('dispatches DELETE_BUSINESSUNIT actions', async () => {
      const arg = 42666;
