...
import reducer, {
  ...
  reset,
  updateEntity,
} from './inspection-route-group.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSPECTIONROUTEGROUP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSPECTIONROUTEGROUP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSPECTIONROUTEGROUP actions', async () => {
      const arg = { id: 'fe493f9b-8f71-4f0c-bd8f-4fc730b3449a' };
    ...
    it('dispatches UPDATE_INSPECTIONROUTEGROUP actions', async () => {
      const arg = { id: 'fe493f9b-8f71-4f0c-bd8f-4fc730b3449a' };
    ...
    it('dispatches PARTIAL_UPDATE_INSPECTIONROUTEGROUP actions', async () => {
    ...
    it('dispatches DELETE_INSPECTIONROUTEGROUP actions', async () => {
      const arg = 42666;
