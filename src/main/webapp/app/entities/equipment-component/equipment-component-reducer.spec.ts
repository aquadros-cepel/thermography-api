...
import reducer, {
  ...
  reset,
  updateEntity,
} from './equipment-component.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EQUIPMENTCOMPONENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EQUIPMENTCOMPONENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EQUIPMENTCOMPONENT actions', async () => {
      const arg = { id: '215f448c-cb7c-42d1-b2c0-93952cf51c59' };
    ...
    it('dispatches UPDATE_EQUIPMENTCOMPONENT actions', async () => {
      const arg = { id: '215f448c-cb7c-42d1-b2c0-93952cf51c59' };
    ...
    it('dispatches PARTIAL_UPDATE_EQUIPMENTCOMPONENT actions', async () => {
    ...
    it('dispatches DELETE_EQUIPMENTCOMPONENT actions', async () => {
      const arg = 42666;
