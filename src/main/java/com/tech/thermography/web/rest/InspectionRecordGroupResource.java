...
/**
 * REST controller for managing {@link com.tech.thermography.domain.InspectionRecordGroup}.
 */
@RestController
...
public class InspectionRecordGroupResource {
    ...
    public InspectionRecordGroupResource(InspectionRecordGroupRepository inspectionRecordGroupRepository) {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new inspectionRecordGroup, or with status {@code 400 (Bad Request)} if the inspectionRecordGroup has already an ID.
    ...
    /**
     * {@code PUT  /inspection-record-groups/:id} : Updates an existing inspectionRecordGroup.
     *
     * @param id the id of the inspectionRecordGroup to save.
     * @param inspectionRecordGroup the inspectionRecordGroup to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated inspectionRecordGroup,
     * or with status {@code 400 (Bad Request)} if the inspectionRecordGroup is not valid,
     * or with status {@code 500 (Internal Server Error)} if the inspectionRecordGroup couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/{id}")
    ...
    /**
     * {@code PATCH  /inspection-record-groups/:id} : Partial updates given fields of an existing inspectionRecordGroup, field will ignore if it is null
     *
     * @param id the id of the inspectionRecordGroup to save.
     * @param inspectionRecordGroup the inspectionRecordGroup to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated inspectionRecordGroup,
     * or with status {@code 400 (Bad Request)} if the inspectionRecordGroup is not valid,
     * or with status {@code 404 (Not Found)} if the inspectionRecordGroup is not found,
     * or with status {@code 500 (Internal Server Error)} if the inspectionRecordGroup couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
     ...
     *
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of inspectionRecordGroups in body.
     */
    @GetMapping("")
    ...
    /**
     * {@code GET  /inspection-record-groups/:id} : get the "id" inspectionRecordGroup.
     *
     * @param id the id of the inspectionRecordGroup to retrieve.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the inspectionRecordGroup, or with status {@code 404 (Not Found)}.
     */
    @GetMapping("/{id}")
    ...
    /**
     * {@code DELETE  /inspection-record-groups/:id} : delete the "id" inspectionRecordGroup.
     *
