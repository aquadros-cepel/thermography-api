...
/**
 * REST controller for managing {@link com.tech.thermography.domain.UserInfo}.
 */
@RestController
...
public class UserInfoResource {
        ...
        Optional<UserInfo> result = userInfoRepository
            ...
            .map(existingUserInfo -> {
                if (userInfo.getPosition() != null) {
                    existingUserInfo.setPosition(userInfo.getPosition());
                }
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteUserInfo(@PathVariable("id") UUID id) {
