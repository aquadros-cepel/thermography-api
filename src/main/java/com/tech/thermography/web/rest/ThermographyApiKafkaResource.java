...
import com.tech.thermography.broker.KafkaConsumer;
...
public class ThermographyApiKafkaResource {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ThermographyApiKafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public ThermographyApiKafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
